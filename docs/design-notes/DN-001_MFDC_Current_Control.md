...
- иметь отдельный механизм/лимит для **volt-seconds / балансировки трансформатора** (если это актуально для выбранной силовой схемы), чтобы не допускать накопления DC‑составляющей и “flux walking” (см. `docs/theory/MFDC_Current_Loop_and_Fault_Model_STM32G474.md` / раздел про volt-seconds).
