...
Прикладной протокол обмена с фреймингом по `0xFF`, полем длины и CRC16. В проекте используется для обмена “плата ↔ ПК” по USB-UART: настройка параметров, осциллографирование/логирование и сервисный режим отладки (в т.ч. обёртка legacy CAN-кадров *(устар.)*). См. `docs/protocols/PCCOM4.02.md`.
