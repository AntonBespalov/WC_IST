...
Если запрос касается разработки кода в safety/RT доменах — учитывать общий инженерный контракт: `docs/ENGINEERING_CONTRACT.md`.
...
Если запрос касается разработки кода в safety/RT доменах:
→ соблюдать `docs/ENGINEERING_CONTRACT.md` (defensive design, fast/slow sync, overrun policy, proof obligations).
...
> Соблюдай общий инженерный контракт разработки: `docs/ENGINEERING_CONTRACT.md` (defensive design, fast/slow sync, proof).
