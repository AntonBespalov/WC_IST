...
> Внимание: в профиле SmartAxis.USPF (УСПФ) используется другой порядок байт для `Версия ПО` (см. `docs/protocols/PCCOM4.02_PROJECT.md` / раздел 11.3.6).
...
Проектные команды/узлы и соглашения вынесены в `docs/protocols/PCCOM4.02_PROJECT.md`.
