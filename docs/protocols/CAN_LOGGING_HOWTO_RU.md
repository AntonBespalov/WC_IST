...
Связанные документы:
- `docs/protocols/PROTOCOL_TK.md` — описание протокола (каноника).
- `docs/protocols/tk_protocol.dbc` — машинно‑читаемое описание (для декодирования/сниффинга; пока скелет).
