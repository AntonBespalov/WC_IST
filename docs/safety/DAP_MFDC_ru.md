...
- **Связь с ТК:** CAN, частота обновления уставки 1 кГц  
...
> **Снятие энергии не должно зависеть исключительно от программного обеспечения или CAN‑связи.**
...
### SF‑4: Потеря управляющих команд (CAN‑timeout)
...
- **Опасная ситуация:** потеря или искажение CAN‑команд  
- **Меры снижения риска:**
  - таймаут CAN;
...
- real‑time контур (измерение → регулятор → обновление ШИМ) изолирован от CAN и логирования;
