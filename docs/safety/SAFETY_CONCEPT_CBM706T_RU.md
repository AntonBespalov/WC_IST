...
Требование к “антизомби” поведению watchdog:
- Вход `WDI` внешнего супервизора должен иметь **аппаратную подтяжку** к пассивному уровню, чтобы во время reset/Hi‑Z на GPIO МК не возникали ложные “пинки” watchdog.
- Дизайн должен гарантировать, что пассивный уровень **не совпадает** с активным фронтом/уровнем, по которому супервизор считает heartbeat.
