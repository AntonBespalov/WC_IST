...
Синхронизация: основные факты ниже приведены в соответствие с каноническими документами `docs/` (см. `docs/DOCS_INDEX.md`) по состоянию на **2026-01-29**.
...
- Осциллографирование/логирование процессов: **USB-UART → ПК** (не блокировать fast loop; буферизация/DMA)
