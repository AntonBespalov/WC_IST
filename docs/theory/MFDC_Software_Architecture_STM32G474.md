...
4. **CAN и технологическая логика не имеют приоритета над током**
...
|                  RTOS (FreeRTOS)                 |
|                                                  |
|  [Task_CAN]   [Task_Process]   [Task_Diagnostics]|
|       |             |                 |          |
+-------|-------------|-----------------|----------+
        |             |                 |
        v             v                 v
...
⚠️ ISR **не использует malloc, RTOS, CAN, printf**
