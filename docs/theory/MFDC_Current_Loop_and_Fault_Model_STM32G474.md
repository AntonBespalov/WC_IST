...
## Детализация контура тока и fault-model (STM32G474 + AD7380 + Rogowski + CAN 1 кГц)
...
- `I_ref_slow` — уставка от технологического слоя (1 кГц, CAN/FSМ)
...
- Проверка latch/reset политики и CAN-отчётов
