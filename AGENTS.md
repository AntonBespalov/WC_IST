...
9) `skills/*` — правила формата ответов и акценты (skills не должны спорить с контекстом)
...
Если задача начинается как “давай обсудим/спроектируем/прикинем архитектуру” **или** есть пробелы в MUST-полях `М1–М5` — сначала использовать skill `system-design-interrogation` (файл: `skills/_optional/system-design-interrogation.md`).
